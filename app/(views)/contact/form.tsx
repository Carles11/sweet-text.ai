  ...
  return (
    ...
    >
      ...
      <input
        ...
        name="fullname"
        className="bg-transparent border-b py-2 pl-4 focus:outline-none rounded-md focus:ring-1 ring-green-500 font-light text-gray-500"
      />

      <label
        htmlFor="email"
        className="text-gray-500 font-light mt-4 text-gray-50"
      >
